...
void Event::setEventID(const int new_var)
{
			eventID = new_var;
}
...
void Event::setMeasurementValue(const double new_var)
{
...
void Event::setDateOccured(const string new_var)
{
			dateOccured = new_var;
}
...
void Event::setImagePath(const string new_var)
{
			imagePath = new_var;
}
...
void Event::setNotes(const string new_var)
{
			notes = new_var;
}
...
void Event::setShow(const bool new_var)
{
			show = new_var;
}
